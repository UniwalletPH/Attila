...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Attila.Domain.Entities.Tables.EquipmentRestock", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("tbl_EquipmentRestock");
                });
            ...
            modelBuilder.Entity("Attila.Domain.Entities.Tables.EventDetails", b =>
                {
                    ...
                    b.HasIndex("EventPackageDetailsID");
            ...
            modelBuilder.Entity("Attila.Domain.Entities.Tables.EventDetails", b =>
                {
                    b.HasOne("Attila.Domain.Entities.Tables.EventClient", "EventClient")
                        .WithMany()
                        .HasForeignKey("EventClientID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Attila.Domain.Entities.Tables.EventPackageDetails", "EventPackageDetails")
                        .WithMany()
                        .HasForeignKey("EventPackageDetailsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Attila.Domain.Entities.Tables.EventPaymentStatus", b =>
                {
                    b.HasOne("Attila.Domain.Entities.Tables.EventDetails", "EventDetails")
                        .WithMany()
