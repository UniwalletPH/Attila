    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_EquipmentRestock", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tbl_EquipmentRestockRequest_tbl_User_UserID",
                        column: x => x.UserID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tbl_EventDetails_tbl_EventClient_EventClientID",
                        column: x => x.EventClientID,
                        principalTable: "tbl_EventClient",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tbl_EventDetails_tbl_EventPackageDetails_EventPackageDetailsID",
                        column: x => x.EventPackageDetailsID,
                        principalTable: "tbl_EventPackageDetails",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tbl_EventDetails_tbl_User_UserID",
                        column: x => x.UserID,
                        principalTable: "tbl_User",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tbl_FoodRestockRequest_tbl_User_UserID",
                        column: x => x.UserID,
                        principalTable: "tbl_User",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbl_EquipmentRestockRequest_UserID",
                table: "tbl_EquipmentRestockRequest",
                column: "UserID");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_EventDetails_EventClientID",
                table: "tbl_EventDetails",
                column: "EventClientID");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_EventDetails_EventPackageDetailsID",
                table: "tbl_EventDetails",
                column: "EventPackageDetailsID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbl_FoodRestockRequest_UserID",
                table: "tbl_FoodRestockRequest",
                column: "UserID");
